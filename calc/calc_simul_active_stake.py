...
class SimulRewardCalculation(object):
    ...
    def get_pool_params(self, active_stake):
        ...
        self.params["pool_active_stake"] = int(active_stake)
    ...
    def calculate_params(self):
        ...
        if self.params["sigma_prime"] > self.params["z0"]:
            self.params["sigma_prime"] = self.params["z0"]
    ...
    def simul_set_active_stake(self, simul_active_stake):
        self.params["pool_active_stake"] = simul_active_stake
